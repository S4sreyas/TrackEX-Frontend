...
class _AddAccountDetailsWidgetState extends State<AddAccountDetailsWidget> {
  ...
  final TextEditingController _branchNameController = TextEditingController();
  final TextEditingController _ifscCodeController = TextEditingController();
  final TextEditingController _uniqueCodeController = TextEditingController(); // New controller for unique code
  final TextEditingController _pinController = TextEditingController();
  final TextEditingController _confirmPinController = TextEditingController();
  ...
  Future<void> _submitDetails() async {
    ...
    final data = {
      ...
      'branch_name': _branchNameController.text,
      'ifsc_code': _ifscCodeController.text,
      'unique_code': _uniqueCodeController.text, // Include unique code field
      'pin_no': _pinController.text, // new field for PIN
    };
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration:
                const InputDecoration(labelText: "Unique Code (6 digits)"),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "Enter unique code";
                  }
                  if (value.length != 6) {
                    return "Unique code must be 6 digits";
                  }
                  if (!RegExp(r'^[0-9]{6}$').hasMatch(value)) {
                    return "Unique code must be numeric";
                  }
                  return null;
                },
              ),
