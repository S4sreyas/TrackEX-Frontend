...
class UtilitiesWidget extends StatefulWidget {
  const UtilitiesWidget({Key? key}) : super(key: key);

  @override
  _UtilitiesWidgetState createState() => _UtilitiesWidgetState();
}

class _UtilitiesWidgetState extends State<UtilitiesWidget> {
  TextEditingController? budgetController;
  bool isEditable = true; // Determines whether the user can edit the budget.
  String displayBudget = '0'; // Displayed budget value.
  final String categoryName = 'UTILITIES';
