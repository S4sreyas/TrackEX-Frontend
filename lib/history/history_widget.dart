...
class _HistoryWidgetState extends State<HistoryWidget> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var expense in data) {
          ...
          // Assume that positive amounts are expenses (spent)
          if (amount > 0) {
            spent += amount;
          }
        }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            children: [
              // Transaction Summary Card - Spent only
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Spent summary section
                      _buildSpentSummaryItem(
                        'Total Spent',
                        _totalSpent,
                        Colors.red,
  ...
  // Helper method to build spent summary item
  Widget _buildSpentSummaryItem(String title, double amount, Color color) {
    return Container(
      padding: const EdgeInsets.all(16.0),
